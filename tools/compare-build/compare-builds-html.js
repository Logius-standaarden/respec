...
function createStableSnapshot() {
  execSync(
    "npx respec --localhost --src tools/compare-build/logius-build-stable.html --out tools/compare-build/stableSnapshot.html",
    (error, stdout, stderr) => {
      console.log(error);
      console.log(stdout);
      console.log(stderr);
...
// create snapshot with the current build in builds/respec-logius.js
  execSync(
    "npx respec --localhost --src tools/compare-build/logius-build-current.html --out tools/compare-build/currentSnapshot.html",
    (error, stdout, stderr) => {
      console.log(error);
      console.log(stdout);
      console.log(stderr);
...
// load current snapshot
  ...
  console.log("Comparing: current --> stable")
  if (result.different) {
    if (writeToLog) {
